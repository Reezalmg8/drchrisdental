    ...
    <div className="min-h-screen bg-gradient-to-b from-[#E6D5E6] via-[#F2E6F2] to-[#E6D5E6] font-sans">
      ...
      <main className="container mx-auto px-4 py-24">
        ...
        >
          ...
          <h1 className="text-4xl font-bold text-[#666666] mb-8">About Dr. Christina's Dental Clinic</h1>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          ...
          <motion.div
            ...
            transition={{ duration: 0.5, delay: 0.2 }}
          >
            <h2 className="text-2xl font-bold text-[#666666] mb-4">Our Story</h2>
        ...
        >
          <Card className="mb-8">
            <CardContent className="p-6">
              <h2 className="text-2xl font-bold text-[#666666] mb-4">Our Mission</h2>
              <p className="text-[#666666] mb-4">
        ...
        >
          <Card className="mb-12">
            <CardContent className="p-6">
              <h2 className="text-2xl font-bold text-[#666666] mb-4">Our Approach</h2>
        ...
        >
          <h2 className="text-3xl font-bold text-[#666666] mb-8">Meet Our Team</h2>
